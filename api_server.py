#!/usr/bin/env python3
"""FastAPI server exposing the logistics AI email-processing workflow."""
...
async def process_email(request: EmailRequest):
    ...
    try:
        ...
        logger.info(
            f"Processing email from {request.sender} in thread {request.thread_id or 'new'}"
        )
...
if __name__ == "__main__":
    uvicorn.run("api_server:app", host="0.0.0.0", port=5001, reload=True, log_level="info")
