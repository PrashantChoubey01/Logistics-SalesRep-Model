...
class ConversationStateAgent(BaseAgent):
    ...
    def __init__(self):
        ...
        # Conversation states centred on thread progression.
    ...
    def _analyze_conversation_state(
        self, subject: str, email_text: str, message_thread: List[Dict[str, Any]], thread_id: str
    ) -> Dict[str, Any]:
                    ...
                    "properties": {
                        ...
                        "thread_context": {
                            ...
                            "properties": {
                                "is_thread": {
                                    "type": "boolean",
                                    "description": "Whether this is part of an email thread",
                                },
                                "email_count": {
                                    "type": "integer",
                                ...
                                "has_bot_response": {
                                    "type": "boolean",
                                    "description": "Whether bot has already responded in this thread",
                                },
                                "conversation_progression": {
                                    "type": "string",
                                    "description": "How the conversation has progressed (new request, clarification, confirmation, etc.)",
                                },
                                "missing_information": {
                                    "type": "array",
                                    "items": {"type": "string"},
                                    "description": "Information still missing from customer",
                                },
                                "previous_topics": {
                                    "type": "array",
                                    "items": {"type": "string"},
                                    "description": "Topics discussed in previous emails",
                                },
                            },
...
"""
            ...
            if result.get("conversation_stage") not in self.conversation_states:
                self.logger.warning(
                    f"Invalid conversation_stage: {result.get('conversation_stage')}, defaulting to new_thread"
                )
            ...
            self.logger.info(
                f"Conversation state analysis successful: {result['conversation_stage']} (confidence: {result['confidence_score']:.2f})"
            )
