...
Generates confirmation acknowledgment responses when customers confirm their
extracted information, acknowledging receipt and proceeding with next steps.
"""
...
class ConfirmationAcknowledgmentAgent(BaseAgent):
    ...
    def generate_confirmation_acknowledgment(
        self,
        ...
        try:
            ...
            logger.info(
                f"Generated confirmation acknowledgment with quote timeline: {quote_timeline}"
            )
            return response
    ...
    def _generate_subject_line(
        ...
        try:
            ...
            if (
                origin
                and destination
                and origin != "your origin"
                and destination != "your destination"
            ):
    ...
    def _build_response_body(
        ...
        if include_forwarder_info:
            response_parts.extend([template["forwarder_assignment"], ""])
            ...
            if any(shipment.values()):
                ...
                if shipment.get("origin"):
                    ...
                    if port_lookup_result and port_lookup_result.get("origin"):
                        ...
                        original_port_name = origin_result.get(
                            "original_port_name", shipment["origin"]
                        )
                        port_name = (
                            origin_result.get("port_name")
