...
class ForwarderResponseAgent(BaseAgent):
    ...
    def _generate_rate_quote_acknowledgment(self, forwarder_name: str, email_data: Dict[str, Any], rate_info: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Use LLM to generate human-friendly response
...
Requirements:
1. Be human, friendly, and professional in tone
2. Acknowledge receipt of their rate quote in 1-2 sentences
3. Mention that the sales team will review it
4. ALWAYS present rate details in a CLEAR, STRUCTURED FORMAT using bullet points like this:
   ...
   * Valid Until: [date]
5. Keep the acknowledgment text concise and warm
6. Don't add any "Next Steps" section
7. End with this exact signature:
   Best regards,
   Sales Team
   SeaRates by DP World
   sales@searates.com

IMPORTANT: Always use bullet points for rate details, never embed them in sentences.
...
If you have any urgent requirements, please let us know.
...
We'll also arrange all the necessary details for pickup and delivery.
...
You'll receive an update within 4 hours.
...
If you have any urgent requirements, please don't hesitate to reach out to us directly.
