...
class ShipmentDetails(BaseModel):
    ...
    destination_country: Optional[StrictStr] = Field(
        None, description="Country for destination port"
    )
    inco_terms: Optional[StrictStr] = Field(None, description="Commercial terms, e.g., FOB, CIF")
    cargo_description: Optional[StrictStr] = Field(
        None, description="High-level product description"
    )
