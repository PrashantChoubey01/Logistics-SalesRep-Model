...
**You should see:**
```
Serving HTTP on :: port 5002 (http://[::]:5002/) ...
```
...
- Verify you're using the correct URL: `http://localhost:5002`

### Issue: Page is blank or shows file listing

**Solution:**
- Make sure you're accessing `http://localhost:5002` (not a file path)
...
1. What you see when you open `http://localhost:5002`
