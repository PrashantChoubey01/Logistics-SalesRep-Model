...
The frontend logs to the browser console. When you click "Process Email", you should see messages similar to:
...
Check the browser console output - it logs each step and shows where the process is failing.
